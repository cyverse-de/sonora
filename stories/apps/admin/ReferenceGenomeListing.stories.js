    ...
    const genomesListing = {
        genomes: [
            ...
            },
            {
                ...
                name:
                    "Brachypodium distachyon [Purple false brome] (Ensembl 14)",
                path:
            ...
            },
            {
                ...
                name:
                    "Saccharomyces cerevisiae [Baker's yeast] (Ensembl 14_67)",
                path:
            ...
            },
            {
                ...
                name:
                    "Saccharomyces cerevisiae [Baker's yeast] (Ensembl 19_72)",
                path:
            ...
            },
            {
                ...
                name:
                    "Brachypodium distachyon [Purple false brome] (Ensembl 19)",
                path:
            ...
            },
            {
                ...
                name:
                    "Tursiops truncatus [Bottlenosed dolphin] (Ensembl 14_67)",
                path:
            ...
            },
            {
                ...
                name:
                    "Xenopus tropicalis [Western clawed frog] (Ensembl 14_67)",
                path:
            ...
            },
            {
                ...
                name:
                    "Populus trichocarpa [Western balsam poplar] (Ensembl 14)",
                path:
