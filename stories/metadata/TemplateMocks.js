...
export const DataciteMetadataTemplate = {
    ...
    attributes: [
        ...
        },
        {
            ...
            name: "LocalContexts",
            description:
                "This field is for [Local Contexts](https://localcontexts.org) Label and Notice metadata.\n\nNote that in the Discovery Environment, this field will display only one field for the Local Contexts Hub Project URI. When a valid project URI is entered, all other required metadata is auto-populated, including any Notices or Labels fetched from the Local Contexts Hub API for that project.\n\nWhen downloading this metadata template as a CSV file for use in Bulk Metadata uploads, this field should contain the Local Contexts Rights Label or Notice text.\nSee the DataCite guide on these metadata fields for some examples: https://support.datacite.org/docs/local-contexts-notices-and-labels\nNote that notices should use the exact text from its landing page. For more information on Notices see https://localcontexts.org/notices/aboutnotices/",
            required: false,
            type: "String",
            attributes: [
                {
